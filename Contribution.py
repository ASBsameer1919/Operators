...
Ans:
'''
def calculate_flood_contribution():
    # Input for salaries
    ...
    senior_contribution = (senior_salary * 0.50) * senior_players
    junior_contribution = (junior_salary * 0.40) * junior_players
